...
/**
 * ClaimLineLog.Delete API specification (optional)
...
function civicrm_api3_claim_line_delete($params) {
  if (array_key_exists('id', $params)) {
    return civicrm_api3_create_success(CRM_Expenseclaims_BAO_ClaimLineLog::deleteWithId($params['id']), $params, 'ClaimLineLog', 'Delete');
  } else {
